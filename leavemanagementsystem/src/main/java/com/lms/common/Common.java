...
public class Common {
    ...
    public static String getToken() throws Exception {
        ...
        String redirectUri="http://localhost:9099/something";
...
//                new GoogleAuthorizationCodeFlow.Builder(new UrlFetchTransport(),new JacksonFactory(),
//                clientId,clientSecret, Collections.singleton(scope)).setAccessType("offline").build();
        //flow.loadCredential("akilac@hsenidmobile.com");


        //credential.getAccessToken();
        //String tokenString=credential.getAccessToken();
...
//        TokenResponse tokenResponse=flow.newTokenRequest(code).execute();
//
//        flow.createAndStoreCredential(tokenResponse,"akilac@hsenidmobile.com");
...
//        return "";
    ...
    public static List<User> printUserList(){
        ...
        //headers.set("Authorization","Bearer  ya29.CjC8A6DMqrxDlv53OV2mdX4tL0JYmmBG4mCuPI4GnW88p2H5d0s7M1sAn0TrJ5neIEU");
        String authorization="Bearer  "+((token==null)?"ya29.Ci-7A4uGmOGk5oRY97MoRnIZZBXAU8hpECU9obN-j4FjsMhYFCczdKwMTZnU9Smycw":token);
        //headers.set("Authorization","Bearer  ya29.Ci-7A4uGmOGk5oRY97MoRnIZZBXAU8hpECU9obN-j4FjsMhYFCczdKwMTZnU9Smycw");
        if(token!=null) {
        ...
        for (Users users:body.getUsers()){
            ...
            user.setUserName(users.getName().getFullname());
            userList.add(user);
